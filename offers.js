...
const OFFERS = [
  ...
  { br:'Q7', topic:'quan-7', name:'Miễn phí cho BẠN GÁI đi cùng bạn trai', price:'Vé bạn trai 150k',
    ...
    cond:'Cặp đôi 15–35 tuổi · áo đôi cùng màu, in hình/chữ giống nhau · Mang CCCD · chương trình thường niên' },
  { br:'Q7', topic:'quan-7', name:'Miễn phí cho 1 NGƯỜI LỚN từ 60 tuổi', price:'Vé người đi kèm 150k',
    time:'Sau 19:00', days:'T2-CN', from:null, to:null, holiday:false, annual:true,
    cond:'Phải có 1 người đi kèm từ 18 tuổi · CCCD của cả hai · chương trình thường niên' },
